...
(function () {
    ...
    $(function () {
        ...
        function setUserDate(obj,index,pageObj) {
            ...
            //方框下标
            var one = $("<td class=\"text-center\"><input class='checkboxone' data-delete=\""+obj['username']+"\" type=\"checkbox\" id=\"check5-td1\" name=\"check5-td1\"></td>").get(0);
            var two = $("<td class=\"cell-small text-center\">"+
                (Number(pageObj['data']['pageNo']-1)*Number(pageObj['data']['pageSize']) + index)
                +"</td>").get(0);


            var three = $("<td>"+obj['username']+"</td>").get(0);


            var four = $("<td>"+obj['province']+"</td>").get(0);

            var five = $("<td><div class=\"message_div\">"+obj['message']+"</div></td>").get(0);
            var six = $("<td>"+obj['date']+"</td>").get(0);
...
(function () {
    $(function () {
        ...
        $(document).delegate(".selfedit", 'click', function () {
            ...
            //设置唯一标识
            $(".identify").get(0).innerText = children[2].innerText;
            ...
            $(".messagetext").get(0).innerText = children[4].innerText;
        ...
        butAdd.click(function () {
            ...
            if (butAdd.get(0).innerText == "创建") {
                ...
                $.post({
                    ...
                    if (data['data']['entity']['updateNum'] == 1) {
        ...
        $(document).delegate(".selfdelete", 'click', function () {
            ...
            if (confirm("确定删除 "+children[2].innerText+" 信息?")) {
                $.get({
                    ...
                    url: url+'/dtms',
                    data: {
                        username: children[2].innerText
                    }
                },function (data) {
                    alert(data['data']['message']);

                    if (data['data']['entity']['deleteNum'] == 1) {
                        //修改成功
                        window.location.reload();
                    }
                });
